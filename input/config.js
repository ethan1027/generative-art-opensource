...
const description = "The Lucky Cat that brings you wealth, health, and prosperity";
...
const baseImageUri = "https://my-s3-bucket-change-later";
...
// addRarityPercentForLayer('super_rare', 'background', { 'super_rare': 50, 'rare': 25, 'original': 25 });
// addRarityPercentForLayer('original', 'background', { 'super_rare': 50, 'rare': 25, 'original': 25 });
